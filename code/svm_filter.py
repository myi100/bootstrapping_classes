...
##################################
##Training Data
training = open('/Users/muhammedyidris/git/bootstrapping_classes/data/doca_protest.txt').read()
...
del training_set[-1]
false = open('/Users/muhammedyidris/git/bootstrapping_classes/data/non_protests.txt').read()
...
###################################
##Test Data
path = '/Users/muhammedyidris/git/bootstrapping_classes/nyt/formatted_nyt'
...
print 'Classification time: '+str(elapsed_time/60)+' min'
print 'Frequency:\n'+str(itemfreq(predicted))+'\n'


p_fileno = 0
positive_cases = open('/Users/muhammedyidris/git/bootstrapping_classes/nyt/filtered_nyt/filtered_nyt-'+str(p_fileno)+'.txt', 'w+')
p = 0

k_fileno = 0
keyword_cases = open('/Users/muhammedyidris/git/bootstrapping_classes/nyt/filtered_nyt/by_keyword/filtered_nyt_by_keyword-'+str(k_fileno)+'.txt', 'w+')
k = 0
...
for i in range(0, len(predicted)):
	if predicted[i] == 1:
		if positive_cases.tell() + sys.getsizeof(test_set[i]) > 90004741:
		...
		if any(key in test_set[i][0:300] for key in keywords):
			if keyword_cases.tell() + sys.getsizeof(test_set[i]) > 90004741:
				keyword_cases.close()
				k_fileno+=1
				keyword_cases = open('/Users/muhammedyidris/git/bootstrapping_classes/nyt/filtered_nyt/by_keyword/filtered_nyt_by_keyword-'+str(k_fileno)+'.txt', 'w+')
