...
positive_cases = open('/Users/muhammedyidris/bootstrapping_classes/filtered_nyt.txt', 'w+')
p = 0
keyword_cases = open('/Users/muhammedyidris/bootstrapping_classes/filtered_nyt_by_keyword.txt', 'w+')
k = 0
